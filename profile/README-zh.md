...
| **扫码转换** | spz2glb 网页端读取二维码并转换 | 二维码→SPZ→GLB | 🚧 v3.0 实验版支持（规划中） |
...
- **状态**：实验性开发中，v3.0 实验版规划扫码即转换，远期探索扫码即渲染
...
v2.1 正式发布后将公开完整后续版本路线图。当前采用季度迭代节奏，v3.0 暂定丙午年季夏至孟秋（公历 2026 年 Q3）发布，计划同步适配 SPZ_2 草案规范的下一阶段内容，具体以最终发布说明为准。
